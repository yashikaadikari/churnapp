...
pickle_in = open("best_gb_model.pkl", "rb")
...
def main():
    ...
    AVG_RSRP = st.number_input("AVG RSRP", min_value=-140.000000, step=0.000001)
    ...
    CONGESTION_STATUS_NOT_IMPACTED = st.selectbox("CONJESTION STATUS NOT IMPACTED",options=["Yes","No"])
    ...
    features = {
        ...
        "PAYER_TYPE_OUTSTANDING PAYMASTERS": binary_map[PAYER_TYPE_OUTSTANDING_PAYMASTERS],
        ...
        "CPE_MODEL_ZLT S10": binary_map[CPE_MODEL_ZLT_S10],
        "CPE_MODEL_B310s-925": binary_map[CPE_MODEL_B310S_925],
        "PACKAGE_ID_LTE_AD_I": binary_map[PACKAGE_ID_LTE_AD_I],
        "CONJESTION_STATUS_NOT IMPACTED": binary_map[CONGESTION_STATUS_NOT_IMPACTED],
    }
